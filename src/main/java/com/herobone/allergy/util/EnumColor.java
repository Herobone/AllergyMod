...
public enum EnumColor implements IStringSerializable
{
	...
	private static final LanguageMap localizedName = new LanguageMap();
	...
	{
		return localizedName.translateKey("color." + unlocalizedName);
	}

	public String getDyeName()
	{
		return localizedName.translateKey("dye." + unlocalizedName);
	}
